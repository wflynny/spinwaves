...
#        print self_set, old_set
#        for el in self_set: print 'self', el, el.is_commutative
#        for el in old_set: print 'old', el, el.is_commutative
        ...
        for i in terms_old:
            ...
            #elif i.is_Pow and i.exp == sympy.Rational(1,2): l_temp(sympy.sqrt(i.base))
                    ...
                    if self_noncomm[i] == old_noncomm[0]:
                        for j in range(len(old_noncomm)):
                            ...
                            if j == len(old_noncomm) - 1 and i+j < len(self_noncomm) and self_noncomm[i+j] == old_noncomm[j]:
                                ...
                                b. If there aren't any to begin with, then append new and
